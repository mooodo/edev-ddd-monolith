...
public class RepositoryTest {
    ...
    public void testSaveAndDelete() {
        Long id = 1L;
        Order order = Order.build().setValues(id,10001L,1000100L,null);
        Customer customer = Customer.build().setValues(10001L,"李秋水","女",
                "510110197910012312","13388990123");
        order.setCustomer(customer);
        Address address = Address.build()
                .setValues(1000100L,10001L,"中国","湖北",
                "武汉","洪山区","珞瑜路726号","13300224466");
        order.setAddress(address);
        Long accountId = 1000901L;
        Payment payment = Payment.build().setValues(order.getId(), accountId);
        order.setPayment(payment);
        OrderItem orderItem0 = OrderItem.build()
                .setValues(11L,id,30001L,1L,4000D,null);
        Product product0 = Product.build()
                .setValues(30001L,"Apple iPhone X 256GB 深空灰色 移动联通电信4G手机",4000D,
                "台",20004L,"手机","/static/img/product1.jpg",5600D,"自营");
        orderItem0.setProduct(product0);
        order.addOrderItem(orderItem0);
        OrderItem orderItem1 = OrderItem.build()
                .setValues(12L,id,30004L,2L,958D,null);
        Product product1 = Product.build()
                .setValues(30004L,"Kindle Paperwhite电纸书阅读器 电子书墨水屏 6英寸wifi 黑色",958D,
        ...
        Customer excepted = Customer.build()
                .setValues(10002L,"逍遥子","男","510110197607103322","13422584349");
    ...
    public void testSaveAndDeleteForList() {
        Long id0 = 1L;
        Order order0 = Order.build()
                .setValues(id0,10001L,1000100L,null);
        Customer customer0 = Customer.build().setValues(10001L,"李秋水","女",
                "510110197910012312","13388990123");
        order0.setCustomer(customer0);
        Address address0 = Address.build()
                .setValues(1000100L,10001L,"中国","湖北",
                "武汉","洪山区","珞瑜路726号","13300224466");
        order0.setAddress(address0);

        Long id1 = 2L;
        Order order1 = Order.build().setValues(id1,10001L,1000100L,null);
        Customer customer1 = Customer.build().setValues(10001L,"李秋水","女",
                "510110197910012312","13388990123");
        ...
        OrderItem orderItem0 = OrderItem.build()
                .setValues(21L,id1,30001L,1L,4000D,null);
        Product product0 = Product.build()
                .setValues(30001L,"Apple iPhone X 256GB 深空灰色 移动联通电信4G手机",4000D,
                "台",20004L,"手机","/static/img/product1.jpg",5600D,"自营");
        orderItem0.setProduct(product0);
        ...
        OrderItem orderItem1 = OrderItem.build()
                .setValues(22L,id1,30004L,2L,958D,null);
        Product product1 = Product.build()
                .setValues(30004L,"Kindle Paperwhite电纸书阅读器 电子书墨水屏 6英寸wifi 黑色",958D,
                "个",20002L,"电子书","/static/img/product4.jpg",999D,"秒杀");
        orderItem1.setProduct(product1);
        ...
        Customer customer2 = Customer.build()
                .setValues(10002L,"逍遥子","男","510110197607103322","13422584349");
        ...
        OrderItem orderItem2 = OrderItem.build()
                .setValues(23L,id1,null,10L,300D,3000D);
    ...
    public void testSaveAndDeleteWithManyToMany() {
        Long id = 1L;
        User user = User.build().setValues(id,"Johnwood","123");
        Authority authority0 = Authority.build()
                .setValues(50001L,"registerUser",true);
        Authority authority1 = Authority.build()
                .setValues(50002L,"modifyUser",true);
        ...
        Authority authority2 = Authority.build()
                .setValues(50003L,"removeUser",true);
    ...
    public void testSaveAndDeleteWithManyToManyForList() {
        Long id0 = 1L;
        User user0 = User.build().setValues(id0,"Johnwood","123");
        Long id1 = 2L;
        User user1 = User.build().setValues(id1,"Mary","123");
        Authority authority0 = Authority.build()
                .setValues(50001L,"registerUser",true);
        Authority authority1 = Authority.build()
                .setValues(50002L,"modifyUser",true);
